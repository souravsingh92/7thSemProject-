        ...
        <div className="bg-white shadow">
          <div className="p-6 sm:p-12">
            ...
            <button
              ...
              className="mt-5  inline-block bg-white text-black px-5 py-3 text-xs font-medium uppercase tracking-wide"
            >
              View Your Orders
            </button>
            <div className="mt-6">
                    ...
                    addresses.map((item) => (
                      <div className="border p-6" key={item._id}>
                        ...
                        <button
                          ...
                          className="mt-5 mr-5 inline-block bg-white text-black px-5 py-3 text-xs font-medium uppercase tracking-wide"
                        >
                          Update
                        </button>
                        <button
